...
export default function TeacherSignup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const user = await AuthService.signUp(email, password, 'teacher', displayName.trim());
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-quest-blue-50 via-quest-purple-50 to-quest-blue-100 flex items-center justify-center">
        <div className="text-center">
          <div className="animate-spin rounded-full h-16 w-16 border-b-2 border-quest-fire-600 mx-auto mb-4"></div>
          <p className="text-quest-fire-700 font-game text-lg">Redirecting to your dashboard...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-quest-blue-50 via-quest-purple-50 to-quest-blue-100 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
          className="absolute top-1/4 right-10 text-quest-purple-400 opacity-25"
        ...
        <motion.div
          className="absolute top-1/3 left-1/2 text-quest-purple-400 opacity-20"
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        <motion.button
          onClick={() => router.push('/')}
          className="mb-8 flex items-center text-quest-fire-600 font-game font-bold hover:text-quest-fire-700 transition-colors duration-150"
          whileHover={{ x: -3 }}
          whileTap={{ scale: 0.95 }}
        >
        ...
        <div className="max-w-md mx-auto">
          ...
          >
            ...
            <h1 className="text-4xl font-heading font-bold text-quest-fire-700 mb-2">
              Create Teacher Account
            </h1>
            <p className="text-quest-gray-600 font-game text-lg">
              Start creating amazing learning adventures!
            </p>
          </motion.div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="relative">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-4 border-2 border-quest-gray-200 rounded-game focus:border-quest-fire-400 focus:outline-none transition-colors font-game text-lg"
              ...
              <div className="relative">
                ...
                <div className="relative">
                  <FontAwesomeIcon 
                    icon={faEnvelope} 
                    className="absolute left-4 top-1/2 transform -translate-y-1/2 text-quest-fire-400" 
                  />
                  <input
                    type="email"
                    value={email}
              ...
              <div className="relative">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-4 top-1/2 transform -translate-y-1/2 text-quest-gray-400 hover:text-quest-fire-400 transition-colors"
                  >
              ...
              <motion.button
                type="submit"
                disabled={isLoading}
                className="w-full bg-quest-fire-500 hover:bg-quest-fire-600 text-white font-bold py-4 px-6 rounded-game text-xl shadow-game hover:shadow-game-hover transition-all duration-150 disabled:opacity-50 disabled:cursor-not-allowed relative overflow-hidden"
                whileHover={{ y: -2 }}
                whileTap={{ y: 0 }}
              >
                {isLoading ? (
            ...
            >
              <p className="text-quest-gray-500 font-game text-sm">
                ...
                <button
                  ...
                  className="text-quest-fire-600 hover:text-quest-fire-700 font-bold transition-colors"
                >
                  Sign in here
                </button>
              </p>
